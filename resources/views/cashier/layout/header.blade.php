<nav class="navbar navbar-expand-lg fixed-top shadow">
    <div class="container-fluid" id="navbar-main">
        ...
        <a href="{{ route('cashier.dashboard') }}" class="navbar-brand">OLAISA LAUNDRY</a>
...
<div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvas" aria-labelledby="offcanvas">
    <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="offcanvas-label">Cashier Dashboard</h5>
        <button class="btn-close" type="button" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
    <div class="offcanvas-body d-flex flex-column">
        <a href="{{ route('c-members.index') }}" class="btn btn-secondary mb-2">Members</a>
        <a href="{{ route('c-transactions.index') }}" class="btn btn-secondary mb-2">Transactions</a>
        <a href="{{ route('cashier.transaction.report') }}" class="btn btn-secondary mb-2">Transaction Report</a>
    </div>
</div>