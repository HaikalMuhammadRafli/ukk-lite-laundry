...
class MemberController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.members.index', $data)->with('no', ($request->input('page', 1) - 1 ) * 20);
    }
    ...
    public function update(Request $request, Member $member)
    {
        ...
        if ($member->update($input)) {
            return redirect()->route('members.index')->with('success', 'Member has been edited!');
        } else {
            return redirect()->route('members.index')->with('error', 'Something went wrong!');
        }
    }
